...
| Tree/Wiki 双 tab | ✅ 完成 | 2026-07-19 | `ThemeDetailScreen` 导航栏 middle 放 Tree/Wiki segmented 切换；tree tab 顶部一行整合 doc split / 搜索 / add node；overflow menu 只保留树级全局操作；Wiki tab 由 wiki 模块提供阅读器 |
