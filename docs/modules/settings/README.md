...
- 联网搜索偏好：`web_search_enabled_{providerType}` key 持久化，支持 Anthropic、KIMI、MIMO、DeepSeek、豆包、xAI 等 `webSearchSupportMap.supported` 提供商（OpenAI / TokenHub / MiniMax 为 unsupported）
